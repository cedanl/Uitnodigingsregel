...
user_train_path = Path(settings.get('user_data_dir_train', './data/01-raw/user_data/train.csv'))
...
prepared = student_signal.prepare(
    ...
    id_col=settings['studentnumber_column'],
    config={"imputation": {"n_neighbors": settings['knn_neighbors']}},
)
train_processed = prepared.train_df
train_df_sdd = prepared.train_df_scaled
